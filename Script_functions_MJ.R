...
###Get pop data from .out output (GetPopData) ####
...
###Colours####
Qual_col =  c("#0072B2","#D55E00")
Stage_col <- c("#4B0055",  "#0197BD", "#36E9A7")
Stage_col_MJ <- c( "#7570b3","#4B0055",  "#0197BD", "#36E9A7")
Res_colours <- c("#E63946", "#00B4A0")